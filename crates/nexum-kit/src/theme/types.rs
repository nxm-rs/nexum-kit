/// Accent color presets matching original NexumKit
...
impl ThemeVars {
    ...
    pub fn to_css_string(&self) -> String {
        format!(
            "--nk-colors-accentColor:{};--nk-colors-accentColorForeground:{};--nk-colors-actionButtonBorder:{};--nk-colors-actionButtonBorderMobile:{};--nk-colors-actionButtonSecondaryBackground:{};--nk-colors-closeButton:{};--nk-colors-closeButtonBackground:{};--nk-colors-connectButtonBackground:{};--nk-colors-connectButtonBackgroundError:{};--nk-colors-connectButtonInnerBackground:{};--nk-colors-connectButtonText:{};--nk-colors-connectButtonTextError:{};--nk-colors-connectionIndicator:{};--nk-colors-downloadBottomCardBackground:{};--nk-colors-downloadTopCardBackground:{};--nk-colors-error:{};--nk-colors-generalBorder:{};--nk-colors-generalBorderDim:{};--nk-colors-menuItemBackground:{};--nk-colors-modalBackdrop:{};--nk-colors-modalBackground:{};--nk-colors-modalBorder:{};--nk-colors-modalText:{};--nk-colors-modalTextDim:{};--nk-colors-modalTextSecondary:{};--nk-colors-profileAction:{};--nk-colors-profileActionHover:{};--nk-colors-profileForeground:{};--nk-colors-selectedOptionBorder:{};--nk-colors-standby:{};--nk-fonts-body:{};--nk-radii-actionButton:{};--nk-radii-connectButton:{};--nk-radii-menuButton:{};--nk-radii-modal:{};--nk-radii-modalMobile:{};--nk-shadows-connectButton:{};--nk-shadows-dialog:{};--nk-shadows-profileDetailsAction:{};--nk-shadows-selectedOption:{};--nk-shadows-selectedWallet:{};--nk-shadows-walletLogo:{};--nk-blurs-modalOverlay:{};",
            self.accent_color,
